  ...
  const features = [
    {
      ...
      description: "Highly trained and certified physiotherapists dedicated to accurate diagnosis and effective treatment.",
      icon: <Users size={40} className="text-white" />,
    },
    {
      title: "Personalized Care",
      description: "Every treatment plan is tailored to your condition, goals, and lifestyle for maximum recovery.",
      icon: <Heart size={40} className="text-white" />,
    },
    {
      title: "Modern Techniques",
      description: "We use advanced physiotherapy methods and up-to-date clinical practices for better results.",
      icon: <Lightbulb size={40} className="text-white" />,
    },
    {
      title: "Friendly Environment",
      description: "Experience compassionate care in a calm and welcoming clinic that prioritizes your comfort.",
      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            ...
            >
              {/* Icon Circle */}
              <div className="bg-black rounded-full p-6 mb-6">
                {feature.icon}
              </div>
